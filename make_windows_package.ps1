...
cp $build_dir/source_modules/qmx_source/Release/qmx_source.dll sdrpp_windows_x64/modules/
cp $build_dir/source_modules/qmxserver_source/Release/qmxserver_source.dll sdrpp_windows_x64/modules/
