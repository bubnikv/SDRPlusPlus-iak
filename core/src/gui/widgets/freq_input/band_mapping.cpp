...
//   P = the identity probes stored in the BandMapping.
//
...
namespace freq_input {
    ...
    namespace {
        ...
        static constexpr auto HAM_BANDS = std::array{
            ...
            // Source map for band:amateur:600m
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:amateur:600m`.
            //   P: 502.5 kHz; hits all 1 assigned rows; unique-row coverage 1.
            hamBand("600m", "band:amateur:600m",
                502500LL),

            // Source map for band:amateur:160m
            //   K: R1 "160m" 1.81 MHz-2 MHz; R2/R3 "160m" 1.8 MHz-2 MHz.
            //   O: G/R3 "160m" 1.8 MHz-2 MHz; R1/R2 "160m" 1.81 MHz-2 MHz.
            //   L: 25 row(s), 18 plan(s); all names/spans: legacy audit section `band:amateur:160m`.
            ...
            // Source map for band:amateur:80m
            ...
            //   L: 35 row(s), 18 plan(s); all names/spans: legacy audit section `band:amateur:80m`.
            ...
            // Source map for band:amateur:60m
            //   K: any "60m" 5.25 MHz-5.45 MHz.
            //   O: G "60m" 5.25 MHz-5.45 MHz; R1/R2/R3 "60m" 5.3515 MHz-5.3665 MHz.
            //   L: 26 row(s), 14 plan(s); all names/spans: legacy audit section `band:amateur:60m`.
            ...
            // Source map for band:amateur:40m
            //   K: R1 "40m" 7 MHz-7.2 MHz; R2/R3 "40m" 7 MHz-7.3 MHz.
            //   O: G/R2 "40m" 7 MHz-7.3 MHz; R1/R3 "40m" 7 MHz-7.2 MHz.
            //   L: 29 row(s), 18 plan(s); all names/spans: legacy audit section `band:amateur:40m`.
            ...
            // Source map for band:amateur:30m
            ...
            //   L: 22 row(s), 18 plan(s); all names/spans: legacy audit section `band:amateur:30m`.
            ...
            // Source map for band:amateur:20m
            //   K: any "20m" 14 MHz-14.35 MHz.
            //   O: G/R1/R2/R3 "20m" 14 MHz-14.35 MHz.
            //   L: 35 row(s), 18 plan(s); all names/spans: legacy audit section `band:amateur:20m`.
            ...
            // Source map for band:amateur:17m
            //   K: any "17m" 18.068 MHz-18.168 MHz.
            //   O: G/R1/R2/R3 "17m" 18.068 MHz-18.168 MHz.
            //   L: 24 row(s), 17 plan(s); all names/spans: legacy audit section `band:amateur:17m`.
            ...
            // Source map for band:amateur:15m
            //   K: any "15m" 21 MHz-21.45 MHz.
            //   O: G/R1/R2/R3 "15m" 21 MHz-21.45 MHz.
            //   L: 27 row(s), 18 plan(s); all names/spans: legacy audit section `band:amateur:15m`.
            ...
            // Source map for band:amateur:12m
            //   K: any "12m" 24.89 MHz-24.99 MHz.
            //   O: G/R1/R2/R3 "12m" 24.89 MHz-24.99 MHz.
            //   L: 24 row(s), 18 plan(s); all names/spans: legacy audit section `band:amateur:12m`.
            ...
            // Source map for band:amateur:10m
            //   K: any "10m" 28 MHz-29.7 MHz.
            //   O: G/R1/R2/R3 "10m" 28 MHz-29.7 MHz.
            //   L: 64 row(s), 18 plan(s); all names/spans: legacy audit section `band:amateur:10m`.
            ...
            // Source map for band:amateur:8m
            //   K: none.
            //   O: G "8m" 40.66 MHz-40.7 MHz.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:amateur:8m`.
            //   P: 40.675 MHz; hits all 1 assigned rows; unique-row coverage 1.
            hamBand("8m", "band:amateur:8m",
                40675000LL),

            // Source map for band:amateur:6m
            //   K: none.
            //   O: G/R1/R2/R3 "6m" 50 MHz-54 MHz.
            //   L: 17 row(s), 17 plan(s); all names/spans: legacy audit section `band:amateur:6m`.
            ...
            // Source map for band:amateur:125cm
            //   K: none.
            //   O: G/R2 "1.25m" 220 MHz-225 MHz.
            //   L: 5 row(s), 4 plan(s); all names/spans: legacy audit section `band:amateur:125cm`.
            ...
            // Source map for band:amateur:70cm
            //   K: none.
            //   O: G/R2 "70cm" 420 MHz-450 MHz; R1/R3 "70cm" 430 MHz-440 MHz.
            //   L: 48 row(s), 17 plan(s); all names/spans: legacy audit section `band:amateur:70cm`.
            ...
            // Source map for band:amateur:33cm
            //   K: none.
            //   O: none.
            //   L: 4 row(s), 4 plan(s); all names/spans: legacy audit section `band:amateur:33cm`.
            //   P: 915 MHz; hits all 4 assigned rows; unique-row coverage 4.
            hamBand("33cm", "band:amateur:33cm",
                915000000LL),

            // Source map for band:amateur:23cm
            //   K: none.
            //   O: G/R1/R2/R3 "23cm" 1.24 GHz-1.3 GHz.
            //   L: 26 row(s), 16 plan(s); all names/spans: legacy audit section `band:amateur:23cm`.
            ...
            // Source map for band:amateur:13cm
            //   K: none.
            //   O: G/R1/R3 "13cm" 2.3 GHz-2.45 GHz; R2 "13cm" 2.32 GHz-2.45 GHz.
            //   L: 23 row(s), 15 plan(s); all names/spans: legacy audit section `band:amateur:13cm`.
            ...
            // Source map for band:amateur:9cm
            //   K: none.
            //   O: G/R2/R3 "9cm" 3.3 GHz-3.5 GHz; R1 "9cm" 3.4 GHz-3.475 GHz.
            //   L: 7 row(s), 6 plan(s); all names/spans: legacy audit section `band:amateur:9cm`.
            ...
            // Source map for band:amateur:5cm
            //   K: none.
            //   O: G "6cm" 5.65 GHz-5.925 GHz; R1 "6cm" 5.65 GHz-5.85 GHz; R2/R3 "5cm" 5.65 GHz-5.925 GHz.
            //   L: 17 row(s), 10 plan(s); all names/spans: legacy audit section `band:amateur:5cm`.
            ...
            // Source map for band:amateur:3cm
            //   K: none.
            //   O: G/R1/R2/R3 "3cm" 10 GHz-10.5 GHz.
            //   L: 22 row(s), 10 plan(s); all names/spans: legacy audit section `band:amateur:3cm`.
            ...
            // Source map for band:amateur:12mm
            //   K: none.
            //   O: none.
            //   L: 10 row(s), 8 plan(s); all names/spans: legacy audit section `band:amateur:12mm`.
            ...
            // Source map for band:amateur:6mm
            //   K: none.
            //   O: none.
            //   L: 9 row(s), 9 plan(s); all names/spans: legacy audit section `band:amateur:6mm`.
            //   P: 47.101 GHz; hits all 9 assigned rows; unique-row coverage 9.
            hamBand("6mm", "band:amateur:6mm",
                47101000000LL),

            // Source map for band:amateur:4mm
            //   K: none.
            //   O: none.
            //   L: 7 row(s), 7 plan(s); all names/spans: legacy audit section `band:amateur:4mm`.
            //   P: 77.25 GHz; hits all 7 assigned rows; unique-row coverage 7.
            hamBand("4mm", "band:amateur:4mm",
                77250000000LL),

            // Source map for band:amateur:25mm
            //   K: none.
            //   O: none.
            //   L: 7 row(s), 7 plan(s); all names/spans: legacy audit section `band:amateur:25mm`.
            ...
            // Source map for band:amateur:2mm
            //   K: none.
            //   O: none.
            //   L: 9 row(s), 8 plan(s); all names/spans: legacy audit section `band:amateur:2mm`.
            ...
            // Source map for band:amateur:1mm
            //   K: none.
            //   O: none.
            //   L: 7 row(s), 7 plan(s); all names/spans: legacy audit section `band:amateur:1mm`.
        ...
        static constexpr auto BROADCAST_BANDS = std::array{
            ...
            // Source map for band:broadcast:22m
            //   K: any "22m" 13.57 MHz-13.87 MHz.
            //   O: G/R1/R2/R3 "22m Broadcast" 13.57 MHz-13.87 MHz.
            //   L: 16 row(s), 14 plan(s); all names/spans: legacy audit section `band:broadcast:22m`.
            ...
            // Source map for band:broadcast:19m
            //   K: any "19m" 15.1 MHz-15.8 MHz.
            //   O: G/R1/R2/R3 "19m Broadcast" 15.1 MHz-15.83 MHz.
            //   L: 16 row(s), 14 plan(s); all names/spans: legacy audit section `band:broadcast:19m`.
            ...
            // Source map for band:broadcast:fm
            //   K: none.
            //   O: G/R1/R2/R3 "FM Broadcast" 87.5 MHz-108 MHz.
            //   L: 20 row(s), 17 plan(s); all names/spans: legacy audit section `band:broadcast:fm`.
            ...
            // Source map for band:broadcast:television:vhf-low
            //   K: none.
            //   O: none.
            //   L: 5 row(s), 3 plan(s); all names/spans: legacy audit section `band:broadcast:television:vhf-low`.
            //   P: 60 MHz, 82 MHz; hits all 5 assigned rows; unique-row coverage 3/2.
            televisionBand(
                "Television VHF low",
                "band:broadcast:television:vhf-low",
                60000000LL, 82000000LL),
            // Source map for band:broadcast:television:vhf-high
            //   K: none.
            //   O: none.
            //   L: 7 row(s), 6 plan(s); all names/spans: legacy audit section `band:broadcast:television:vhf-high`.
            ...
            // Source map for band:broadcast:television:uhf
            //   K: none.
            //   O: none.
            //   L: 15 row(s), 11 plan(s); all names/spans: legacy audit section `band:broadcast:television:uhf`.
            ...
            // Source map for band:broadcast:weather-radio
            //   K: none.
            //   O: bookmarks.d/us/noaa.json NOAA-1..NOAA-7 at 162.4..162.55 MHz (channels, not Band rows).
            //   L: 3 row(s), 3 plan(s); all names/spans: legacy audit section `band:broadcast:weather-radio`.
        ...
        static constexpr auto AVIATION_BANDS = std::array{
            ...
            // Source map for band:aviation:hf:23mhz
            //   K: none.
            //   O: none.
            //   L: 4 row(s), 4 plan(s); all names/spans: legacy audit section `band:aviation:hf:23mhz`.
            //   P: 23.275 MHz; hits all 4 assigned rows; unique-row coverage 4.
            aviationBand("HF 23 MHz", "band:aviation:hf:23mhz",
                23275000LL),
            // Source map for band:aviation:vhf-voice
            //   K: none.
            //   O: G/R1/R2/R3 "VHF Air" 108 MHz-137 MHz.
            //   L: 18 row(s), 13 plan(s); all names/spans: legacy audit section `band:aviation:vhf-voice`.
            ...
            // Source map for band:aviation:l-band
            //   K: none.
            //   O: G/R1/R2/R3 "ADS-B" 960 MHz-1.215 GHz.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:aviation:l-band`.
        ...
        static constexpr auto MARITIME_BANDS = std::array{
            // Source map for band:maritime:mf
            //   K: any "MF" 505 kHz-526.5 kHz.
            //   O: none.
            //   L: 2 row(s), 2 plan(s); all names/spans: legacy audit section `band:maritime:mf`.
            //   P: 515.75 kHz; hits all 2 assigned rows; unique-row coverage 2.
            maritimeBand("MF", "band:maritime:mf",
                515750LL),
            // Source map for band:maritime:hf:2mhz
            //   K: any "2 MHz" 2.1735 MHz-2.1905 MHz.
            //   O: none.
            //   L: 3 row(s), 3 plan(s); all names/spans: legacy audit section `band:maritime:hf:2mhz`.
            //   P: 2.182 MHz; hits all 3 assigned rows; unique-row coverage 3.
            maritimeBand("HF 2 MHz", "band:maritime:hf:2mhz",
                2182000LL),
            // Source map for band:maritime:hf:4mhz
            //   K: any "4 MHz" 4.063 MHz-4.438 MHz.
            //   O: none.
            //   L: 11 row(s), 6 plan(s); all names/spans: legacy audit section `band:maritime:hf:4mhz`.
        ...
        static constexpr auto PERSONAL_RADIO_BANDS = std::array{
            // Source map for band:personal-radio:cb
            //   K: none.
            //   O: G/R1/R2/R3 "11m CB" 26.965 MHz-28 MHz.
            //   L: 15 row(s), 14 plan(s); all names/spans: legacy audit section `band:personal-radio:cb`.
            ...
            // Source map for band:personal-radio:lpd433
            //   K: none.
            ...
            //   L: 2 row(s), 1 plan(s); all names/spans: legacy audit section `band:personal-radio:frs-gmrs`.
            ...
            // Source map for band:personal-radio:uhf-cb
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:personal-radio:uhf-cb`.
        ...
        static constexpr auto ISM_BANDS = std::array{
            // Source map for band:ism:6mhz
            //   K: selector 4 "ISM" 6.765 MHz-6.795 MHz.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:ism:6mhz`.
            //   P: 6.78 MHz; hits all 1 assigned rows; unique-row coverage 1.
            ismBand("6 MHz", "band:ism:6mhz",
                6780000LL),
            // Source map for band:ism:13mhz
            ...
            ismBand("13 MHz", "band:ism:13mhz",
                13560000LL),
            // Source map for band:ism:27mhz
            //   K: selector 4 "ISM" 26.957 MHz-27.283 MHz.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:ism:27mhz`.
            //   P: 27.12 MHz; hits all 1 assigned rows; unique-row coverage 1.
            ismBand("27 MHz", "band:ism:27mhz",
                27120000LL),
            // Source map for band:ism:40mhz
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:ism:40mhz`.
            //   P: 40.68 MHz; hits all 1 assigned rows; unique-row coverage 1.
            ismBand("40 MHz", "band:ism:40mhz",
                40680000LL),
            // Source map for band:ism:433mhz
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:ism:433mhz`.
            //   P: 433.92 MHz; hits all 1 assigned rows; unique-row coverage 1.
            ismBand("433 MHz", "band:ism:433mhz",
                433920000LL),
            // Source map for band:ism:868mhz
            //   K: none.
            //   O: G/R1 "EU868" 862 MHz-870 MHz.
            //   L: 4 row(s), 4 plan(s); all names/spans: legacy audit section `band:ism:868mhz`.
            ...
            // Source map for band:ism:915mhz
            //   K: none.
            //   O: G/R2 "US915" 902 MHz-928 MHz; G/R3 "AU915" 915 MHz-928 MHz.
            //   L: 2 row(s), 2 plan(s); all names/spans: legacy audit section `band:ism:915mhz`.
            ...
            // Source map for band:ism:2ghz
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:ism:2ghz`.
            //   P: 2.45 GHz; hits all 1 assigned rows; unique-row coverage 1.
            ismBand("2.4 GHz", "band:ism:2ghz",
                2450000000LL),
            // Source map for band:ism:24ghz
            //   K: none.
            //   O: none.
            //   L: 2 row(s), 2 plan(s); all names/spans: legacy audit section `band:ism:24ghz`.
            //   P: 24.25 GHz; hits all 2 assigned rows; unique-row coverage 2.
            ismBand("24 GHz", "band:ism:24ghz",
                24250000000LL),
            // Source map for band:ism:61ghz
            //   K: none.
            //   O: none.
            //   L: 2 row(s), 2 plan(s); all names/spans: legacy audit section `band:ism:61ghz`.
            //   P: 61.5 GHz; hits all 2 assigned rows; unique-row coverage 2.
            ismBand("61 GHz", "band:ism:61ghz",
                61500000000LL),
            // Source map for band:ism:122ghz
            //   K: none.
            //   O: none.
            //   L: 2 row(s), 2 plan(s); all names/spans: legacy audit section `band:ism:122ghz`.
        ...
        // split follows the actually shipped Wi-Fi rows; unsupported generic
        // 5 GHz ISM duplicates are deliberately absent.
        static constexpr auto RLAN_BANDS = std::array{
            // Source map for band:rlan:2ghz
            //   K: none.
            //   O: none.
            //   L: 4 row(s), 4 plan(s); all names/spans: legacy audit section `band:rlan:2ghz`.
            //   P: 2.45 GHz; hits all 4 assigned rows; unique-row coverage 4.
            rlanBand("2.4 GHz", "band:rlan:2ghz",
                2450000000LL),
            // Source map for band:rlan:5ghz-lower
            //   K: none.
            //   O: none.
            //   L: 4 row(s), 4 plan(s); all names/spans: legacy audit section `band:rlan:5ghz-lower`.
            //   P: 5.25 GHz; hits all 4 assigned rows; unique-row coverage 4.
            rlanBand("5 GHz lower", "band:rlan:5ghz-lower",
                5250000000LL),
            // Source map for band:rlan:5ghz-middle
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:rlan:5ghz-middle`.
            //   P: 5.68 GHz; hits all 1 assigned rows; unique-row coverage 1.
            rlanBand("5 GHz middle", "band:rlan:5ghz-middle",
                5680000000LL),
            // Source map for band:rlan:5ghz-upper
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:rlan:5ghz-upper`.
            //   P: 5.761 GHz; hits all 1 assigned rows; unique-row coverage 1.
        ...
        static constexpr auto CELLULAR_BANDS = std::array{
            // Source map for band:cellular:gsm-r-900
            //   K: none.
            //   O: none.
            //   L: 5 row(s), 3 plan(s); all names/spans: legacy audit section `band:cellular:gsm-r-900`.
            ...
            // Source map for band:cellular:gsm-900
            //   K: none.
            //   O: none.
            //   L: 6 row(s), 3 plan(s); all names/spans: legacy audit section `band:cellular:gsm-900`.
            ...
            // Source map for band:cellular:dcs-1800
            //   K: none.
            //   O: none.
            //   L: 6 row(s), 3 plan(s); all names/spans: legacy audit section `band:cellular:dcs-1800`.
            ...
            // Source map for band:cellular:eutran:28
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:cellular:eutran:28`.
            ...
            // Source map for band:cellular:eutran:20
            //   K: none.
            //   O: none.
            //   L: 4 row(s), 3 plan(s); all names/spans: legacy audit section `band:cellular:eutran:20`.
            ...
            // Source map for band:cellular:eutran:8
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:cellular:eutran:8`.
            ...
            cellularBand(
                ...
                897500000LL, 942500000LL),
            // Source map for band:cellular:eutran:3
            //   K: none.
            //   O: none.
            //   L: 2 row(s), 1 plan(s); all names/spans: legacy audit section `band:cellular:eutran:3`.
            ...
            cellularBand(
                ...
                1747500000LL, 1842500000LL),
            // Source map for band:cellular:eutran:1
            //   K: none.
            //   O: none.
            //   L: 2 row(s), 1 plan(s); all names/spans: legacy audit section `band:cellular:eutran:1`.
            ...
            // Source map for band:cellular:eutran:7
            //   K: none.
            //   O: none.
            //   L: 4 row(s), 2 plan(s); all names/spans: legacy audit section `band:cellular:eutran:7`.
            ...
            // Source map for band:cellular:eutran:32
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:cellular:eutran:32`.
            ...
            cellularBand(
                ...
                1474000000LL),
            // Source map for band:cellular:eutran:38
            //   K: none.
            //   O: none.
            //   L: 1 row(s), 1 plan(s); all names/spans: legacy audit section `band:cellular:eutran:38`.
        ...
        static constexpr auto SATELLITE_BANDS = std::array{
            // Source map for band:satellite:weather-vhf
            //   K: none.
            //   O: G/R1/R2/R3 "VHF Satellite" 137 MHz-138 MHz.
            //   L: 12 row(s), 12 plan(s); all names/spans: legacy audit section `band:satellite:weather-vhf`.
        ...
        static constexpr auto NAVIGATION_BANDS = std::array{
            // Source map for band:navigation:ndb
            //   K: R3 "NDB" 200 kHz-472 kHz; R1 "NDB" 283.5 kHz-472 kHz; R2 "NDB" 190 kHz-535 kHz.
            //   O: none.
            //   L: 2 row(s), 2 plan(s); all names/spans: legacy audit section `band:navigation:ndb`.
            //   P: 344.25 kHz; hits all 2 assigned rows; unique-row coverage 2.
            navigationBand("NDB", "band:navigation:ndb",
                344250LL),
            // Source map for band:navigation:vor-ils
            //   K: none.
            //   O: G/R1/R2/R3 "VHF Air" 108 MHz-137 MHz.
            //   L: 14 row(s), 14 plan(s); all names/spans: legacy audit section `band:navigation:vor-ils`.
            //   P: 112.5 MHz; hits all 14 assigned rows; unique-row coverage 14.
            navigationBand("VOR/ILS", "band:navigation:vor-ils",
                112500000LL),
            // Source map for band:navigation:ils-glide-path
            //   K: none.
            //   O: none.
            //   L: 2 row(s), 2 plan(s); all names/spans: legacy audit section `band:navigation:ils-glide-path`.
