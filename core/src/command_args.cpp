...
void CommandArgsParser::defineAll() {
        ...
        std::string root = (std::string)getenv("HOME") + "/Library/Application Support/sdriak";
#elif defined(__ANDROID__)
        std::string root = "/storage/self/primary/sdriak";
        ...
        std::string root = (std::string)getenv("HOME") + "/.config/sdriak-appimage";
#else
        std::string root = (std::string)getenv("HOME") + "/.config/sdriak";
#endif
